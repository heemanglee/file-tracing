...
import { fetchTrace, type TraceResponse } from "./api/trace";
...
function App(): React.ReactElement {
  ...
  const handleSearch = async (fileUniqueId: string): Promise<void> => {
    ...
    setResult(null);
    try {
      const data = await fetchTrace(fileUniqueId);
      setResult(data);
    } catch (e) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">File Tracer</h1>
